...
console.log(a1, b1, c1); //vai imprimir primeiro 20, depois 2, e 7,5.
...
console.log(resultado1_2, resultado2_2, resultado3_2); //vai ser impresso true, true e false
...
console.log(comparacao1_3, comparacao2_3, comparacao3_3); //o primeiro vai imprimir true, o segundo true, e false
...
console.log(resultado1_10, resultado2_10, resultado3_10);// false, false, true
...
console.log(typeof u15)
console.log(typeof v15)
console.log(u15===v15)
console.log(u15==v15)
...
let quantidadeComprada = 10
console.log((precoDoProduto * quantidadeComprada).toString())
